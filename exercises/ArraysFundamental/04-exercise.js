/**
 * Tienes un array de strings que contienen diferentes palabras, tu reto es retornar un array solo con las que cumplan con la condición 
...
Output: [ 'rosa', 'gafas' ]
 */
const input = ['rosa', 'gol', 'pez', 'día', 'gafas'];
